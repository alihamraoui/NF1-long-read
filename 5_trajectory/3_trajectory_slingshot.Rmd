...
We set the root in the cluster expressing highest level of Sox10 gene.
...
We visualize root cluster and Sox10 expression levels :
...
```{r see_pdts, fig.width = 9, fig.height = 9}
